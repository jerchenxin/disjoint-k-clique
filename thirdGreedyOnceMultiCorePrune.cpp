// g++ -O3 -std=c++17 thirdGreedyOnceMultiCorePrune.cpp CliqueList.cpp -fopenmp -o thirdGreedyOnceMultiCorePrune
// g++ -O3 -std=c++17 thirdGreedyOnceMultiCorePrune.cpp CliqueList.cpp -fopenmp -o thirdGreedyOnceMultiCorePrune -DPRINT_CLIQUE
